...
// ── Expansion pack: two extra levels per category (facts verified) ──
const quizExpansion = {
    programming: [
        [
            { question: "أي بنية بيانات تعمل بمبدأ LIFO (آخر داخل أول خارج)؟", options: ["الطابور Queue", "المكدس Stack", "القائمة المترابطة", "الشجرة"], answer: 1 },
            { question: "ماذا يعني CSS؟", options: ["Cascading Style Sheets", "Computer Style System", "Creative Style Sheets", "Colorful Style Syntax"], answer: 0 },
            { question: "أي رمز يمثل 'يساوي تماماً' في JavaScript؟", options: ["=", "==", "===", "=>"], answer: 2 },
            { question: "أي لغة تُستخدم أساساً لعلوم البيانات والذكاء الاصطناعي؟", options: ["PHP", "Python", "Ruby", "Swift"], answer: 1 },
            { question: "ما هو نظام العد الذي يستخدمه الحاسوب أساساً؟", options: ["العشري", "الثنائي", "الست عشري", "الثماني"], answer: 1 },
            { question: "أي وسم HTML يُنشئ قائمة غير مرتبة؟", options: ["<ol>", "<ul>", "<li>", "<list>"], answer: 1 },
            { question: "ماذا يعني HTTP؟", options: ["HyperText Transfer Protocol", "High Transfer Text Process", "Hyperlink Tool Transfer Path", "Home Text Transfer Protocol"], answer: 0 },
            { question: "أي دالة تطبع شيئاً في وحدة التحكم بـ JavaScript؟", options: ["print()", "echo()", "console.log()", "write()"], answer: 2 },
            { question: "ما هو الامتداد الشائع لملف بايثون؟", options: [".java", ".py", ".js", ".rb"], answer: 1 },
            { question: "أي مما يلي نظام تشغيل مفتوح المصدر؟", options: ["Windows", "macOS", "Linux", "iOS"], answer: 2 }
        ],
        [
            { question: "ما هو الـ Recursion (الاستدعاء الذاتي)؟", options: ["حلقة لا نهائية", "دالة تستدعي نفسها", "نوع متغير", "خطأ برمجي"], answer: 1 },
            { question: "أي بروتوكول آمن لنقل صفحات الويب؟", options: ["HTTP", "FTP", "HTTPS", "SMTP"], answer: 2 },
            { question: "ماذا يعني IDE في البرمجة؟", options: ["Integrated Development Environment", "Internal Data Engine", "Interface Design Editor", "Internet Development Era"], answer: 0 },
            { question: "أي مما يلي قاعدة بيانات علائقية؟", options: ["MongoDB", "Redis", "MySQL", "Cassandra"], answer: 2 },
            { question: "ما الذي يفعله الـ compiler (المترجم)؟", options: ["يشغّل الموقع", "يحوّل الكود إلى لغة الآلة", "يصمم الواجهة", "يخزّن البيانات"], answer: 1 },
            { question: "أي رمز يبدأ به المعرّف class في CSS؟", options: ["#", ".", "@", "&"], answer: 1 },
            { question: "ما هي القيمة التي تعني 'لا شيء' عمداً في JS؟", options: ["undefined", "null", "0", "NaN"], answer: 1 },
            { question: "أي مفهوم يصف إخفاء التفاصيل الداخلية للكائن؟", options: ["الوراثة", "التغليف Encapsulation", "تعدد الأشكال", "التجريد"], answer: 1 },
            { question: "ما هو الـ Big O notation؟", options: ["لغة برمجة", "مقياس تعقيد الخوارزمية", "إطار عمل", "نوع قاعدة بيانات"], answer: 1 },
            { question: "أي أمر Git يحفظ التغييرات في السجل؟", options: ["git push", "git commit", "git clone", "git status"], answer: 1 }
        ]
    ],
    general: [
        [
            { question: "ما هي عاصمة كندا؟", options: ["تورنتو", "أوتاوا", "مونتريال", "فانكوفر"], answer: 1 },
            { question: "كم تستغرق أشعة الشمس للوصول إلى الأرض تقريباً؟", options: ["دقيقة واحدة", "8 دقائق", "ساعة", "ثانية واحدة"], answer: 1 },
            { question: "ما هو أصغر محيط في العالم؟", options: ["الأطلسي", "الهندي", "المتجمد الشمالي", "الهادئ"], answer: 2 },
            { question: "ما هي عملة اليابان؟", options: ["اليوان", "الين", "الوون", "الروبية"], answer: 1 },
            { question: "ما هي أكبر صحراء حارة في العالم؟", options: ["الكبرى (الصحراء الإفريقية)", "صحراء غوبي", "صحراء كالاهاري", "الربع الخالي"], answer: 0 },
            { question: "كم عدد ألوان العلم الأولمبي (عدا الأبيض)؟", options: ["4", "5", "6", "3"], answer: 1 },
            { question: "ما هي اللغة الرسمية في البرازيل؟", options: ["الإسبانية", "البرتغالية", "الإنجليزية", "الفرنسية"], answer: 1 },
            { question: "ما هو المعدن الأغلى ثمناً بين التالي؟", options: ["الفضة", "الذهب", "البلاتين", "النحاس"], answer: 2 },
            { question: "كم عدد الكواكب التي لها حلقات في مجموعتنا الشمسية؟", options: ["1", "2", "4", "8"], answer: 2 },
            { question: "ما هي أطول سلسلة جبال في العالم؟", options: ["الهيمالايا", "الأنديز", "الألب", "روكي"], answer: 1 }
        ],
        [
            { question: "ما هو الكائن الحي الأكبر حجماً على الأرض؟", options: ["الفيل الإفريقي", "الحوت الأزرق", "الديناصور", "القرش الأبيض"], answer: 1 },
            { question: "في أي دولة يقع برج إيفل؟", options: ["إيطاليا", "فرنسا", "بريطانيا", "ألمانيا"], answer: 1 },
            { question: "ما هي وحدة قياس درجة الحرارة الأكثر شيوعاً عالمياً؟", options: ["فهرنهايت", "سيلسيوس", "كلفن", "رانكين"], answer: 1 },
            { question: "كم عدد القلوب لدى الأخطبوط؟", options: ["1", "2", "3", "4"], answer: 2 },
            { question: "ما هي أكبر جزيرة في العالم؟", options: ["مدغشقر", "جرينلاند", "بورنيو", "غينيا الجديدة"], answer: 1 },
            { question: "من اخترع الهاتف؟", options: ["أديسون", "غراهام بل", "نيكولا تسلا", "ماركوني"], answer: 1 },
            { question: "ما اسم المجرّة التي تقع فيها الأرض؟", options: ["أندروميدا", "درب التبانة", "السحابة الكبرى", "المثلث"], answer: 1 },
            { question: "ما هو الحيوان الأسرع على اليابسة؟", options: ["الأسد", "الفهد (الشيتا)", "الحصان", "الغزال"], answer: 1 },
            { question: "كم عدد الأسنان لدى الإنسان البالغ؟", options: ["28", "30", "32", "36"], answer: 2 },
            { question: "ما هي أصغر دولة في العالم؟", options: ["موناكو", "الفاتيكان", "مالطا", "ناورو"], answer: 1 }
        ]
    ],
    science: [
        [
            { question: "ما هو الرمز الكيميائي للذهب؟", options: ["Go", "Au", "Ag", "Gd"], answer: 1 },
            { question: "أي كوكب يُعرف بـ'كوكب الصباح والمساء'؟", options: ["المريخ", "الزهرة", "عطارد", "زحل"], answer: 1 },
            { question: "ما هي الخلية المسؤولة عن نقل الأكسجين في الدم؟", options: ["البيضاء", "الحمراء", "الصفائح", "البلازما"], answer: 1 },
            { question: "ما هي القوة التي تقاوم الحركة بين سطحين؟", options: ["الجاذبية", "الاحتكاك", "الطفو", "المغناطيسية"], answer: 1 },
            { question: "ما هو أقسى الأنسجة في جسم الإنسان؟", options: ["العظم", "مينا الأسنان", "الغضروف", "الأظافر"], answer: 1 },
            { question: "أي غاز نتنفّسه ونحتاجه للحياة؟", options: ["النيتروجين", "الأكسجين", "الهيدروجين", "الهيليوم"], answer: 1 },
            { question: "ما حالة المادة التي يكون فيها الجسيمات متباعدة جداً وتتحرك بحرية؟", options: ["الصلبة", "السائلة", "الغازية", "البلازما"], answer: 2 },
            { question: "ما العدد الذري للهيدروجين؟", options: ["0", "1", "2", "8"], answer: 1 },
            { question: "أي جهاز يقيس النشاط الزلزالي؟", options: ["البارومتر", "السيزموغراف", "الثيرمومتر", "الهيغرومتر"], answer: 1 },
            { question: "ما الكوكب الأبعد عن الشمس؟", options: ["زحل", "أورانوس", "نبتون", "المشتري"], answer: 2 }
        ],
        [
            { question: "من وضع نظرية النسبية؟", options: ["نيوتن", "أينشتاين", "غاليليو", "هوكينغ"], answer: 1 },
            { question: "ما هي وحدة قياس الطاقة؟", options: ["النيوتن", "الجول", "الواط", "الأمبير"], answer: 1 },
            { question: "أي عنصر يستخدم في بطاريات الليثيوم؟", options: ["الصوديوم", "الليثيوم", "البوتاسيوم", "الكالسيوم"], answer: 1 },
            { question: "ما العملية التي يتحول بها السائل إلى غاز؟", options: ["التكثّف", "التبخّر", "التجمّد", "الانصهار"], answer: 1 },
            { question: "ما هو أكبر عضو داخلي في جسم الإنسان؟", options: ["القلب", "الكبد", "الرئة", "الكلية"], answer: 1 },
            { question: "كم تبلغ نسبة الماء التقريبية في جسم الإنسان؟", options: ["30%", "50%", "60%", "90%"], answer: 2 },
            { question: "ما الذي يدرسه علم الفلك؟", options: ["النباتات", "الأجرام السماوية", "الصخور", "الحشرات"], answer: 1 },
            { question: "أي موجات تستخدمها أجهزة الميكروويف؟", options: ["موجات راديوية", "موجات دقيقة (مايكروويف)", "أشعة سينية", "أشعة غاما"], answer: 1 },
            { question: "ما اسم الصبغة الخضراء في النبات؟", options: ["الكاروتين", "الكلوروفيل", "الميلانين", "الهيموغلوبين"], answer: 1 },
            { question: "كم عدد حالات المادة الأساسية؟", options: ["2", "3", "4", "5"], answer: 2 }
        ]
    ],
    history: [
        [
            { question: "أي ملك مصري نُسب إليه تمثال أبو الهول؟", options: ["توت عنخ آمون", "خفرع", "رمسيس الثاني", "خوفو"], answer: 1 },
            { question: "أي ملكة إسبانية دعمت رحلة كولومبوس؟", options: ["فيكتوريا", "إيزابيلا الأولى", "إليزابيث", "كاترين"], answer: 1 },
            { question: "في أي بلد نشأت الألعاب الأولمبية القديمة؟", options: ["روما", "اليونان", "مصر", "فارس"], answer: 1 },
            { question: "من أول رئيس للولايات المتحدة الأمريكية؟", options: ["لينكولن", "جورج واشنطن", "جيفرسون", "فرانكلين"], answer: 1 },
            { question: "أي إمبراطورية حكمت لقرون وعاصمتها إسطنبول؟", options: ["الرومانية", "العثمانية", "الفارسية", "المغولية"], answer: 1 },
            { question: "متى اكتُشفت أمريكا على يد كولومبوس؟", options: ["1392", "1492", "1592", "1450"], answer: 1 },
            { question: "من قائد الفتح الإسلامي للأندلس؟", options: ["طارق بن زياد", "عقبة بن نافع", "خالد بن الوليد", "موسى بن نصير"], answer: 0 },
            { question: "أي حرب وقعت بين 1914 و1918؟", options: ["العالمية الثانية", "العالمية الأولى", "الباردة", "الأهلية"], answer: 1 },
            { question: "من كتب وثيقة استقلال الولايات المتحدة بشكل رئيسي؟", options: ["واشنطن", "توماس جيفرسون", "آدمز", "هاملتون"], answer: 1 },
            { question: "أي حضارة بنت مدينة بترا في الأردن؟", options: ["الرومان", "الأنباط", "الفينيقيون", "البابليون"], answer: 1 }
        ],
        [
            { question: "في أي عام بدأت الهجرة النبوية (التقويم الهجري)؟", options: ["610م", "622م", "632م", "600م"], answer: 1 },
            { question: "من القائد الذي وحّد المغول؟", options: ["هولاكو", "جنكيز خان", "تيمورلنك", "قبلاي خان"], answer: 1 },
            { question: "أي مدينة كانت عاصمة الدولة العباسية؟", options: ["دمشق", "بغداد", "القاهرة", "قرطبة"], answer: 1 },
            { question: "من هو الفاتح الذي عبر جبال الألب بالفيلة؟", options: ["قيصر", "هانيبال", "الإسكندر", "نابليون"], answer: 1 },
            { question: "في أي قارة قامت حضارة الإنكا؟", options: ["إفريقيا", "أمريكا الجنوبية", "آسيا", "أوروبا"], answer: 1 },
            { question: "متى انتهت الحرب الباردة تقريباً؟", options: ["1975", "1991", "2001", "1965"], answer: 1 },
            { question: "أي وثيقة إنجليزية تاريخية وُقّعت عام 1215؟", options: ["إعلان الاستقلال", "الماغنا كارتا", "معاهدة فرساي", "وثيقة الحقوق"], answer: 1 },
            { question: "من كان أول من طاف حول الأرض بحراً (بدأ الرحلة)؟", options: ["كولومبوس", "ماجلان", "فاسكو دا غاما", "ماركو بولو"], answer: 1 },
            { question: "أي مدينة دُفنت تحت رماد بركان فيزوف؟", options: ["أثينا", "بومبي", "روما", "قرطاج"], answer: 1 },
            { question: "من مؤسس علم الجبر المعروف؟", options: ["ابن سينا", "الخوارزمي", "ابن الهيثم", "البيروني"], answer: 1 }
        ]
    ],
    islamic: [
        [
            { question: "كم عدد الأنبياء أولي العزم من الرسل؟", options: ["3", "5", "7", "4"], answer: 1 },
            { question: "ما اسم والدة النبي محمد ﷺ؟", options: ["آمنة", "خديجة", "حليمة", "فاطمة"], answer: 0 },
            { question: "في أي ليلة نزل القرآن لأول مرة؟", options: ["ليلة الإسراء", "ليلة القدر", "ليلة النصف من شعبان", "ليلة الجمعة"], answer: 1 },
            { question: "كم مرة ذُكر اسم 'محمد' في القرآن؟", options: ["مرتان", "أربع مرات", "عشر مرات", "مرة واحدة"], answer: 1 },
            { question: "ما هي أول سورة نزلت من القرآن؟", options: ["الفاتحة", "العلق", "المدثر", "البقرة"], answer: 1 },
            { question: "كم عدد ركعات صلاة الفجر المفروضة؟", options: ["2", "3", "4", "1"], answer: 0 },
            { question: "من هو الصحابي الذي لُقّب بأمين الأمة؟", options: ["أبو عبيدة بن الجراح", "أبو بكر", "عمر", "عثمان"], answer: 0 },
            { question: "ما هي قبلة المسلمين الأولى؟", options: ["الكعبة", "المسجد الأقصى", "المسجد النبوي", "جبل عرفة"], answer: 1 },
            { question: "كم عدد السور المكية تقريباً مقابل المدنية (الأغلب)؟", options: ["المكية أكثر", "المدنية أكثر", "متساوية", "لا سور مكية"], answer: 0 },
            { question: "من أول من جمع القرآن في مصحف واحد؟", options: ["أبو بكر الصديق", "عمر", "عثمان", "علي"], answer: 0 }
        ],
        [
            { question: "ما اسم السورة التي تُسمى 'قلب القرآن'؟", options: ["الرحمن", "يس", "الملك", "الكهف"], answer: 1 },
            { question: "كم سنة دامت دعوة النبي ﷺ في مكة قبل الهجرة؟", options: ["10 سنوات", "13 سنة", "23 سنة", "5 سنوات"], answer: 1 },
            { question: "من هو خاتم الخلفاء الراشدين؟", options: ["عمر", "عثمان", "علي بن أبي طالب", "الحسن"], answer: 2 },
            { question: "ما اسم الكتاب المُنزَل على عيسى عليه السلام؟", options: ["التوراة", "الإنجيل", "الزبور", "الصحف"], answer: 1 },
            { question: "كم عدد أبواب الجنة؟", options: ["7", "8", "9", "10"], answer: 1 },
            { question: "أي شهر هجري تُؤدّى فيه فريضة الحج؟", options: ["رمضان", "ذو الحجة", "محرم", "شعبان"], answer: 1 },
            { question: "من الصحابي الذي اهتزّ لموته عرش الرحمن؟", options: ["سعد بن معاذ", "حمزة", "مصعب بن عمير", "بلال"], answer: 0 },
            { question: "ما هي أطول آية في القرآن الكريم؟", options: ["آية الكرسي", "آية الدَّين", "أول آية في البقرة", "آخر آية في الكهف"], answer: 1 },
            { question: "كم عدد الصحابة الذين بُشّروا بالجنة (العشرة)؟", options: ["7", "10", "12", "5"], answer: 1 },
            { question: "ما اسم الملك الموكل بالوحي؟", options: ["ميكائيل", "جبريل", "إسرافيل", "عزرائيل"], answer: 1 }
        ]
    ],
    sports: [
        [
            { question: "كم عدد لاعبي فريق كرة السلة الأساسيين في الملعب؟", options: ["5", "6", "7", "11"], answer: 0 },
            { question: "في أي رياضة يوجد مصطلح 'هول إن ون'؟", options: ["التنس", "الجولف", "البلياردو", "البولينغ"], answer: 1 },
            { question: "كم تبلغ مدة مباراة كرة القدم الأساسية؟", options: ["60 دقيقة", "90 دقيقة", "120 دقيقة", "45 دقيقة"], answer: 1 },
            { question: "أي دولة استضافت أولمبياد 2021 (طوكيو)؟", options: ["الصين", "اليابان", "كوريا", "البرازيل"], answer: 1 },
            { question: "كم عدد اللاعبين في فريق الكريكيت؟", options: ["9", "11", "7", "5"], answer: 1 },
            { question: "ما الرياضة التي يُعد فيها 'رفائيل نادال' أسطورة؟", options: ["كرة القدم", "التنس", "السلة", "السباحة"], answer: 1 },
            { question: "كم طول مسبح السباحة الأولمبي؟", options: ["25 متر", "50 متر", "100 متر", "75 متر"], answer: 1 },
            { question: "أي بلد فاز بكأس العالم 2018؟", options: ["ألمانيا", "فرنسا", "البرازيل", "كرواتيا"], answer: 1 },
            { question: "في الملاكمة، ماذا يعني 'KO'؟", options: ["نقطة", "ضربة قاضية", "إنذار", "تعادل"], answer: 1 },
            { question: "كم عدد القواعد (القواعد) في لعبة البيسبول؟", options: ["3", "4", "5", "2"], answer: 1 }
        ],
        [
            { question: "من يُلقّب بـ'الجوهرة السوداء' في كرة القدم؟", options: ["مارادونا", "بيليه", "رونالدو", "زيدان"], answer: 1 },
            { question: "أي ناد إنجليزي يُلقّب بـ'الشياطين الحمر'؟", options: ["ليفربول", "مانشستر يونايتد", "أرسنال", "تشيلسي"], answer: 1 },
            { question: "كم عدد أشواط مباراة كرة السلة (NBA)؟", options: ["2", "3", "4", "5"], answer: 2 },
            { question: "في أي رياضة تُستخدم كلمة 'سترايك'؟", options: ["التنس", "البولينغ", "الجولف", "السباحة"], answer: 1 },
            { question: "كم لاعباً في فريق الهوكي على الجليد على الأرض؟", options: ["5", "6", "7", "8"], answer: 1 },
            { question: "أي دولة فازت بأكبر عدد من بطولات كأس العالم؟", options: ["ألمانيا", "البرازيل", "إيطاليا", "الأرجنتين"], answer: 1 },
            { question: "ما اسم أشهر سباق دراجات في فرنسا؟", options: ["جيرو", "طواف فرنسا", "فويلتا", "الدرع"], answer: 1 },
            { question: "في كرة القدم، كم لاعباً يلزم لإلغاء المباراة عند نقص فريق؟", options: ["أقل من 7", "أقل من 9", "أقل من 5", "أقل من 10"], answer: 0 },
            { question: "أي رياضة يُمارسها 'مايكل فيلبس' الأسطوري؟", options: ["الجري", "السباحة", "القفز", "المصارعة"], answer: 1 },
            { question: "كم نقطة قيمة الرمية الحرة في كرة السلة؟", options: ["1", "2", "3", "4"], answer: 0 }
        ]
    ]
};
Object.keys(quizExpansion).forEach((cat) => {
    if (quizDatabase[cat]) quizDatabase[cat].push(...quizExpansion[cat]);
});
