...
const en: CategoryWords = {
  ...
  jobs: [
    { word: 'Doctor', emoji: '👨‍⚕️', difficulty: 'easy' },
    { word: 'Firefighter', emoji: '👨‍🚒', difficulty: 'easy' },
    { word: 'Chef', emoji: '👨‍🍳', difficulty: 'easy' },
    { word: 'Teacher', emoji: '👩‍🏫', difficulty: 'easy' },
    { word: 'Farmer', emoji: '👨‍🌾', difficulty: 'easy' },
    { word: 'Artist', emoji: '🎨', difficulty: 'easy' },
    { word: 'Police Officer', emoji: '👮', difficulty: 'medium' },
    { word: 'Pilot', emoji: '👨‍✈️', difficulty: 'medium' },
    { word: 'Scientist', emoji: '👨‍🔬', difficulty: 'medium' },
    { word: 'Astronaut', emoji: '👨‍🚀', difficulty: 'medium' },
  ],
  history: [
    { word: 'Pyramid', emoji: '🔺', difficulty: 'easy' },
    { word: 'Castle', emoji: '🏰', difficulty: 'easy' },
    { word: 'Crown', emoji: '👑', difficulty: 'easy' },
    { word: 'Sword', emoji: '⚔️', difficulty: 'easy' },
    { word: 'Map', emoji: '🗺️', difficulty: 'easy' },
    { word: 'Dinosaur', emoji: '🦕', difficulty: 'medium' },
    { word: 'Treasure', emoji: '💰', difficulty: 'medium' },
    { word: 'Knight', emoji: '🛡️', difficulty: 'medium' },
    { word: 'Volcano', emoji: '🌋', difficulty: 'medium' },
    { word: 'Mummy', emoji: '🧟', difficulty: 'hard' },
  ],
}
...
const ar: CategoryWords = {
  ...
  vehicles: [
    ...
    { word: 'فلوكة', emoji: '⛵', difficulty: 'medium' },
  ...
  jobs: [
    { word: 'دكتور', emoji: '👨‍⚕️', difficulty: 'easy' },
    { word: 'مطافي', emoji: '👨‍🚒', difficulty: 'easy' },
    { word: 'شيف', emoji: '👨‍🍳', difficulty: 'easy' },
    { word: 'مدرس', emoji: '👩‍🏫', difficulty: 'easy' },
    { word: 'فلاح', emoji: '👨‍🌾', difficulty: 'easy' },
    { word: 'فنان', emoji: '🎨', difficulty: 'easy' },
    { word: 'ضابط', emoji: '👮', difficulty: 'medium' },
    { word: 'طيار', emoji: '👨‍✈️', difficulty: 'medium' },
    { word: 'عالم', emoji: '👨‍🔬', difficulty: 'medium' },
    { word: 'رائد فضاء', emoji: '👨‍🚀', difficulty: 'medium' },
  ],
  history: [
    { word: 'هرم', emoji: '🔺', difficulty: 'easy' },
    { word: 'قلعة', emoji: '🏰', difficulty: 'easy' },
    { word: 'تاج', emoji: '👑', difficulty: 'easy' },
    { word: 'سيف', emoji: '⚔️', difficulty: 'easy' },
    { word: 'خريطة', emoji: '🗺️', difficulty: 'easy' },
    { word: 'ديناصور', emoji: '🦕', difficulty: 'medium' },
    { word: 'كنز', emoji: '💰', difficulty: 'medium' },
    { word: 'فارس', emoji: '🛡️', difficulty: 'medium' },
    { word: 'بركان', emoji: '🌋', difficulty: 'medium' },
    { word: 'مومياء', emoji: '🧟', difficulty: 'hard' },
  ],
}
...
const de: CategoryWords = {
  ...
  jobs: [
    { word: 'Arzt', emoji: '👨‍⚕️', difficulty: 'easy' },
    { word: 'Feuerwehrmann', emoji: '👨‍🚒', difficulty: 'medium' },
    { word: 'Koch', emoji: '👨‍🍳', difficulty: 'easy' },
    { word: 'Lehrer', emoji: '👩‍🏫', difficulty: 'easy' },
    { word: 'Bauer', emoji: '👨‍🌾', difficulty: 'easy' },
    { word: 'Künstler', emoji: '🎨', difficulty: 'easy' },
    { word: 'Polizist', emoji: '👮', difficulty: 'medium' },
    { word: 'Pilot', emoji: '👨‍✈️', difficulty: 'medium' },
    { word: 'Wissenschaftler', emoji: '👨‍🔬', difficulty: 'hard' },
    { word: 'Astronaut', emoji: '👨‍🚀', difficulty: 'medium' },
  ],
  history: [
    { word: 'Pyramide', emoji: '🔺', difficulty: 'easy' },
    { word: 'Burg', emoji: '🏰', difficulty: 'easy' },
    { word: 'Krone', emoji: '👑', difficulty: 'easy' },
    { word: 'Schwert', emoji: '⚔️', difficulty: 'easy' },
    { word: 'Landkarte', emoji: '🗺️', difficulty: 'easy' },
    { word: 'Dinosaurier', emoji: '🦕', difficulty: 'medium' },
    { word: 'Schatz', emoji: '💰', difficulty: 'medium' },
    { word: 'Ritter', emoji: '🛡️', difficulty: 'medium' },
    { word: 'Vulkan', emoji: '🌋', difficulty: 'medium' },
    { word: 'Mumie', emoji: '🧟', difficulty: 'hard' },
  ],
}
