...
const fallbackProjects = [
    ...
    { title: 'KING2 AI v4.0', category: 'Model', description: 'Fine-tuned Qwen2.5-3B-Instruct with QLoRA — Arabic-first AI assistant trained on 142 examples. متخصص بالعربية، البرمجة، الرياضيات، والسلام.', link: 'https://huggingface.co/spaces/RASHID778/king2-qwen2.5-3b', github_link: 'https://huggingface.co/RASHID778/king2-qwen2.5-3b', image_url: '../images/screenshots/king2-ai.svg', technologies: ['Qwen2.5-3B', 'QLoRA', 'Arabic AI', 'Fine-tuned'] },
