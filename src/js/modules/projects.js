...
const fallbackProjects = [
    ...
    { title: 'Maarifah', category: 'App', description: 'منصة تعليمية ومعرفية متكاملة مبنية بـ Flutter (Clean Architecture) — دورات، مقالات، اختبارات، ومساعد ذكي. Educational platform built with Flutter.', image_url: '../images/screenshots/default.svg', technologies: ['Flutter', 'Dart', 'Clean Architecture'] },
    ...
    { title: 'Sketch Battle', category: 'Game', description: 'Drawing battle game with AI judge. Draw words, vote for the best art, and compete with friends in offline and online modes!', link: '/denkmalen', image_url: '../images/screenshots/default.svg', technologies: ['React', 'Canvas', 'AI Judge'] },
    ...
    { title: 'KING2 AI v2.1', category: 'Model', description: 'منصة ذكاء اصطناعي متكاملة — محرك KING2 مع Next.js، FastAPI، QLoRA على Qwen2.5-3B، قاعدة معرفية إسلامية، توليد صور، ومزودين متعددين.', link: '/king2', image_url: '../images/screenshots/king2-ai.svg', technologies: ['Next.js', 'Qwen2.5-3B', 'QLoRA', 'FastAPI', 'Supabase'] },
