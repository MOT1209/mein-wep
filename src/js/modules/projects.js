...
const fallbackProjects = [
    ...
    { title: 'KING2 AI v2.1', category: 'Model', description: 'منصة ذكاء اصطناعي متكاملة — محرك KING2 مع Next.js، FastAPI، QLoRA على Qwen2.5-3B، قاعدة معرفية إسلامية، ومزودين متعددين.', link: 'models/king2.1/index.html', image_url: '../images/screenshots/king2-ai.svg', technologies: ['Next.js', 'Qwen2.5-3B', 'QLoRA', 'FastAPI', 'Supabase'] },
