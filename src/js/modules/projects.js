...
const fallbackProjects = [
    ...
    { title: 'Rashid AI', category: 'App', description: 'Advanced conversational AI assistant powered by Gemini & OpenRouter. Multilingual support.', link: 'models/Rashid-app/index.html', image_url: 'fas fa-robot', technologies: ['Gemini', 'OpenRouter', 'AI'] },
    ...
    { title: 'Rashid AI v2.0', category: 'Model', description: 'The flagship AI model of Rashid. Multilingual conversational AI with advanced capabilities.', link: 'models/Rashid-app/index.html', image_url: 'fas fa-brain', technologies: ['Gemini API', 'OpenRouter', '10+ Languages'] },
